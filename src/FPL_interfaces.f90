...
interface zonalStats
  module procedure zonalstats2d_bytebyte_llf, &
                zonalstats2d_byteshort_llf, &
                zonalstats2d_byteint_llf, &
                zonalstats2d_bytefloat_llf, &
                zonalstats2d_bytedouble_llf, &
                zonalstats2d_shortbyte_llf, &
                zonalstats2d_shortshort_llf, &
                zonalstats2d_shortint_llf, &
                zonalstats2d_shortfloat_llf, &
                zonalstats2d_shortdouble_llf, &
                zonalstats2d_intbyte_llf, &
                zonalstats2d_intshort_llf, &
                zonalstats2d_intint_llf, &
                zonalstats2d_intfloat_llf, &
                zonalstats2d_intdouble_llf, &
                zonalstats2d_floatbyte_llf, &
                zonalstats2d_floatshort_llf, &
                zonalstats2d_floatint_llf, &
                zonalstats2d_floatfloat_llf, &
                zonalstats2d_floatdouble_llf, &
                zonalstats2d_doublebyte_llf, &
                zonalstats2d_doubleshort_llf, &
                zonalstats2d_doubleint_llf, &
                zonalstats2d_doublefloat_llf, &
                zonalstats2d_doubledouble_llf, &
                zonalstats2d_bytebyte_lld, &
                zonalstats2d_byteshort_lld, &
                zonalstats2d_byteint_lld, &
                zonalstats2d_bytefloat_lld, &
                zonalstats2d_bytedouble_lld, &
                zonalstats2d_shortbyte_lld, &
                zonalstats2d_shortshort_lld, &
                zonalstats2d_shortint_lld, &
                zonalstats2d_shortfloat_lld, &
                zonalstats2d_shortdouble_lld, &
                zonalstats2d_intbyte_lld, &
                zonalstats2d_intshort_lld, &
                zonalstats2d_intint_lld, &
                zonalstats2d_intfloat_lld, &
                zonalstats2d_intdouble_lld, &
                zonalstats2d_floatbyte_lld, &
                zonalstats2d_floatshort_lld, &
                zonalstats2d_floatint_lld, &
                zonalstats2d_floatfloat_lld, &
                zonalstats2d_floatdouble_lld, &
                zonalstats2d_doublebyte_lld, &
                zonalstats2d_doubleshort_lld, &
                zonalstats2d_doubleint_lld, &
                zonalstats2d_doublefloat_lld, &
                zonalstats2d_doubledouble_lld, &
                zonalstats3d_bytebyte_llf_ti, &
                zonalstats3d_byteshort_llf_ti, &
                zonalstats3d_byteint_llf_ti, &
                zonalstats3d_bytefloat_llf_ti, &
                zonalstats3d_bytedouble_llf_ti, &
                zonalstats3d_shortbyte_llf_ti, &
                zonalstats3d_shortshort_llf_ti, &
                zonalstats3d_shortint_llf_ti, &
                zonalstats3d_shortfloat_llf_ti, &
                zonalstats3d_shortdouble_llf_ti, &
                zonalstats3d_intbyte_llf_ti, &
                zonalstats3d_intshort_llf_ti, &
                zonalstats3d_intint_llf_ti, &
                zonalstats3d_intfloat_llf_ti, &
                zonalstats3d_intdouble_llf_ti, &
                zonalstats3d_floatbyte_llf_ti, &
                zonalstats3d_floatshort_llf_ti, &
                zonalstats3d_floatint_llf_ti, &
                zonalstats3d_floatfloat_llf_ti, &
                zonalstats3d_floatdouble_llf_ti, &
                zonalstats3d_doublebyte_llf_ti, &
                zonalstats3d_doubleshort_llf_ti, &
                zonalstats3d_doubleint_llf_ti, &
                zonalstats3d_doublefloat_llf_ti, &
                zonalstats3d_doubledouble_llf_ti, &
                zonalstats3d_bytebyte_llf_tf, &
                zonalstats3d_byteshort_llf_tf, &
                zonalstats3d_byteint_llf_tf, &
                zonalstats3d_bytefloat_llf_tf, &
                zonalstats3d_bytedouble_llf_tf, &
                zonalstats3d_shortbyte_llf_tf, &
                zonalstats3d_shortshort_llf_tf, &
                zonalstats3d_shortint_llf_tf, &
                zonalstats3d_shortfloat_llf_tf, &
                zonalstats3d_shortdouble_llf_tf, &
                zonalstats3d_intbyte_llf_tf, &
                zonalstats3d_intshort_llf_tf, &
                zonalstats3d_intint_llf_tf, &
                zonalstats3d_intfloat_llf_tf, &
                zonalstats3d_intdouble_llf_tf, &
                zonalstats3d_floatbyte_llf_tf, &
                zonalstats3d_floatshort_llf_tf, &
                zonalstats3d_floatint_llf_tf, &
                zonalstats3d_floatfloat_llf_tf, &
                zonalstats3d_floatdouble_llf_tf, &
                zonalstats3d_doublebyte_llf_tf, &
                zonalstats3d_doubleshort_llf_tf, &
                zonalstats3d_doubleint_llf_tf, &
                zonalstats3d_doublefloat_llf_tf, &
                zonalstats3d_doubledouble_llf_tf, &
                zonalstats3d_bytebyte_llf_td, &
                zonalstats3d_byteshort_llf_td, &
                zonalstats3d_byteint_llf_td, &
                zonalstats3d_bytefloat_llf_td, &
                zonalstats3d_bytedouble_llf_td, &
                zonalstats3d_shortbyte_llf_td, &
                zonalstats3d_shortshort_llf_td, &
                zonalstats3d_shortint_llf_td, &
                zonalstats3d_shortfloat_llf_td, &
                zonalstats3d_shortdouble_llf_td, &
                zonalstats3d_intbyte_llf_td, &
                zonalstats3d_intshort_llf_td, &
                zonalstats3d_intint_llf_td, &
                zonalstats3d_intfloat_llf_td, &
                zonalstats3d_intdouble_llf_td, &
                zonalstats3d_floatbyte_llf_td, &
                zonalstats3d_floatshort_llf_td, &
                zonalstats3d_floatint_llf_td, &
                zonalstats3d_floatfloat_llf_td, &
                zonalstats3d_floatdouble_llf_td, &
                zonalstats3d_doublebyte_llf_td, &
                zonalstats3d_doubleshort_llf_td, &
                zonalstats3d_doubleint_llf_td, &
                zonalstats3d_doublefloat_llf_td, &
                zonalstats3d_doubledouble_llf_td, &
                zonalstats3d_bytebyte_lld_ti, &
                zonalstats3d_byteshort_lld_ti, &
                zonalstats3d_byteint_lld_ti, &
                zonalstats3d_bytefloat_lld_ti, &
                zonalstats3d_bytedouble_lld_ti, &
                zonalstats3d_shortbyte_lld_ti, &
                zonalstats3d_shortshort_lld_ti, &
                zonalstats3d_shortint_lld_ti, &
                zonalstats3d_shortfloat_lld_ti, &
                zonalstats3d_shortdouble_lld_ti, &
                zonalstats3d_intbyte_lld_ti, &
                zonalstats3d_intshort_lld_ti, &
                zonalstats3d_intint_lld_ti, &
                zonalstats3d_intfloat_lld_ti, &
                zonalstats3d_intdouble_lld_ti, &
                zonalstats3d_floatbyte_lld_ti, &
                zonalstats3d_floatshort_lld_ti, &
                zonalstats3d_floatint_lld_ti, &
                zonalstats3d_floatfloat_lld_ti, &
                zonalstats3d_floatdouble_lld_ti, &
                zonalstats3d_doublebyte_lld_ti, &
                zonalstats3d_doubleshort_lld_ti, &
                zonalstats3d_doubleint_lld_ti, &
                zonalstats3d_doublefloat_lld_ti, &
                zonalstats3d_doubledouble_lld_ti, &
                zonalstats3d_bytebyte_lld_tf, &
                zonalstats3d_byteshort_lld_tf, &
                zonalstats3d_byteint_lld_tf, &
                zonalstats3d_bytefloat_lld_tf, &
                zonalstats3d_bytedouble_lld_tf, &
                zonalstats3d_shortbyte_lld_tf, &
                zonalstats3d_shortshort_lld_tf, &
                zonalstats3d_shortint_lld_tf, &
                zonalstats3d_shortfloat_lld_tf, &
                zonalstats3d_shortdouble_lld_tf, &
                zonalstats3d_intbyte_lld_tf, &
                zonalstats3d_intshort_lld_tf, &
                zonalstats3d_intint_lld_tf, &
                zonalstats3d_intfloat_lld_tf, &
                zonalstats3d_intdouble_lld_tf, &
                zonalstats3d_floatbyte_lld_tf, &
                zonalstats3d_floatshort_lld_tf, &
                zonalstats3d_floatint_lld_tf, &
                zonalstats3d_floatfloat_lld_tf, &
                zonalstats3d_floatdouble_lld_tf, &
                zonalstats3d_doublebyte_lld_tf, &
                zonalstats3d_doubleshort_lld_tf, &
                zonalstats3d_doubleint_lld_tf, &
                zonalstats3d_doublefloat_lld_tf, &
                zonalstats3d_doubledouble_lld_tf, &
                zonalstats3d_bytebyte_lld_td, &
                zonalstats3d_byteshort_lld_td, &
                zonalstats3d_byteint_lld_td, &
                zonalstats3d_bytefloat_lld_td, &
                zonalstats3d_bytedouble_lld_td, &
                zonalstats3d_shortbyte_lld_td, &
                zonalstats3d_shortshort_lld_td, &
                zonalstats3d_shortint_lld_td, &
                zonalstats3d_shortfloat_lld_td, &
                zonalstats3d_shortdouble_lld_td, &
                zonalstats3d_intbyte_lld_td, &
                zonalstats3d_intshort_lld_td, &
                zonalstats3d_intint_lld_td, &
                zonalstats3d_intfloat_lld_td, &
                zonalstats3d_intdouble_lld_td, &
                zonalstats3d_floatbyte_lld_td, &
                zonalstats3d_floatshort_lld_td, &
                zonalstats3d_floatint_lld_td, &
                zonalstats3d_floatfloat_lld_td, &
                zonalstats3d_floatdouble_lld_td, &
                zonalstats3d_doublebyte_lld_td, &
                zonalstats3d_doubleshort_lld_td, &
                zonalstats3d_doubleint_lld_td, &
                zonalstats3d_doublefloat_lld_td, &
                zonalstats3d_doubledouble_lld_td, &
                zonalstats4d_bytebyte_llf_ti_li, &
                zonalstats4d_byteshort_llf_ti_li, &
                zonalstats4d_byteint_llf_ti_li, &
                zonalstats4d_bytefloat_llf_ti_li, &
                zonalstats4d_bytedouble_llf_ti_li, &
                zonalstats4d_shortbyte_llf_ti_li, &
                zonalstats4d_shortshort_llf_ti_li, &
                zonalstats4d_shortint_llf_ti_li, &
                zonalstats4d_shortfloat_llf_ti_li, &
                zonalstats4d_shortdouble_llf_ti_li, &
                zonalstats4d_intbyte_llf_ti_li, &
                zonalstats4d_intshort_llf_ti_li, &
                zonalstats4d_intint_llf_ti_li, &
                zonalstats4d_intfloat_llf_ti_li, &
                zonalstats4d_intdouble_llf_ti_li, &
                zonalstats4d_floatbyte_llf_ti_li, &
                zonalstats4d_floatshort_llf_ti_li, &
                zonalstats4d_floatint_llf_ti_li, &
                zonalstats4d_floatfloat_llf_ti_li, &
                zonalstats4d_floatdouble_llf_ti_li, &
                zonalstats4d_doublebyte_llf_ti_li, &
                zonalstats4d_doubleshort_llf_ti_li, &
                zonalstats4d_doubleint_llf_ti_li, &
                zonalstats4d_doublefloat_llf_ti_li, &
                zonalstats4d_doubledouble_llf_ti_li, &
                zonalstats4d_bytebyte_llf_ti_lf, &
                zonalstats4d_byteshort_llf_ti_lf, &
                zonalstats4d_byteint_llf_ti_lf, &
                zonalstats4d_bytefloat_llf_ti_lf, &
                zonalstats4d_bytedouble_llf_ti_lf, &
                zonalstats4d_shortbyte_llf_ti_lf, &
                zonalstats4d_shortshort_llf_ti_lf, &
                zonalstats4d_shortint_llf_ti_lf, &
                zonalstats4d_shortfloat_llf_ti_lf, &
                zonalstats4d_shortdouble_llf_ti_lf, &
                zonalstats4d_intbyte_llf_ti_lf, &
                zonalstats4d_intshort_llf_ti_lf, &
                zonalstats4d_intint_llf_ti_lf, &
                zonalstats4d_intfloat_llf_ti_lf, &
                zonalstats4d_intdouble_llf_ti_lf, &
                zonalstats4d_floatbyte_llf_ti_lf, &
                zonalstats4d_floatshort_llf_ti_lf, &
                zonalstats4d_floatint_llf_ti_lf, &
                zonalstats4d_floatfloat_llf_ti_lf, &
                zonalstats4d_floatdouble_llf_ti_lf, &
                zonalstats4d_doublebyte_llf_ti_lf, &
                zonalstats4d_doubleshort_llf_ti_lf, &
                zonalstats4d_doubleint_llf_ti_lf, &
                zonalstats4d_doublefloat_llf_ti_lf, &
                zonalstats4d_doubledouble_llf_ti_lf, &
                zonalstats4d_bytebyte_llf_tf_li, &
                zonalstats4d_byteshort_llf_tf_li, &
                zonalstats4d_byteint_llf_tf_li, &
                zonalstats4d_bytefloat_llf_tf_li, &
                zonalstats4d_bytedouble_llf_tf_li, &
                zonalstats4d_shortbyte_llf_tf_li, &
                zonalstats4d_shortshort_llf_tf_li, &
                zonalstats4d_shortint_llf_tf_li, &
                zonalstats4d_shortfloat_llf_tf_li, &
                zonalstats4d_shortdouble_llf_tf_li, &
                zonalstats4d_intbyte_llf_tf_li, &
                zonalstats4d_intshort_llf_tf_li, &
                zonalstats4d_intint_llf_tf_li, &
                zonalstats4d_intfloat_llf_tf_li, &
                zonalstats4d_intdouble_llf_tf_li, &
                zonalstats4d_floatbyte_llf_tf_li, &
                zonalstats4d_floatshort_llf_tf_li, &
                zonalstats4d_floatint_llf_tf_li, &
                zonalstats4d_floatfloat_llf_tf_li, &
                zonalstats4d_floatdouble_llf_tf_li, &
                zonalstats4d_doublebyte_llf_tf_li, &
                zonalstats4d_doubleshort_llf_tf_li, &
                zonalstats4d_doubleint_llf_tf_li, &
                zonalstats4d_doublefloat_llf_tf_li, &
                zonalstats4d_doubledouble_llf_tf_li, &
                zonalstats4d_bytebyte_llf_tf_lf, &
                zonalstats4d_byteshort_llf_tf_lf, &
                zonalstats4d_byteint_llf_tf_lf, &
                zonalstats4d_bytefloat_llf_tf_lf, &
                zonalstats4d_bytedouble_llf_tf_lf, &
                zonalstats4d_shortbyte_llf_tf_lf, &
                zonalstats4d_shortshort_llf_tf_lf, &
                zonalstats4d_shortint_llf_tf_lf, &
                zonalstats4d_shortfloat_llf_tf_lf, &
                zonalstats4d_shortdouble_llf_tf_lf, &
                zonalstats4d_intbyte_llf_tf_lf, &
                zonalstats4d_intshort_llf_tf_lf, &
                zonalstats4d_intint_llf_tf_lf, &
                zonalstats4d_intfloat_llf_tf_lf, &
                zonalstats4d_intdouble_llf_tf_lf, &
                zonalstats4d_floatbyte_llf_tf_lf, &
                zonalstats4d_floatshort_llf_tf_lf, &
                zonalstats4d_floatint_llf_tf_lf, &
                zonalstats4d_floatfloat_llf_tf_lf, &
                zonalstats4d_floatdouble_llf_tf_lf, &
                zonalstats4d_doublebyte_llf_tf_lf, &
                zonalstats4d_doubleshort_llf_tf_lf, &
                zonalstats4d_doubleint_llf_tf_lf, &
                zonalstats4d_doublefloat_llf_tf_lf, &
                zonalstats4d_doubledouble_llf_tf_lf, &
                zonalstats4d_bytebyte_llf_td_li, &
                zonalstats4d_byteshort_llf_td_li, &
                zonalstats4d_byteint_llf_td_li, &
                zonalstats4d_bytefloat_llf_td_li, &
                zonalstats4d_bytedouble_llf_td_li, &
                zonalstats4d_shortbyte_llf_td_li, &
                zonalstats4d_shortshort_llf_td_li, &
                zonalstats4d_shortint_llf_td_li, &
                zonalstats4d_shortfloat_llf_td_li, &
                zonalstats4d_shortdouble_llf_td_li, &
                zonalstats4d_intbyte_llf_td_li, &
                zonalstats4d_intshort_llf_td_li, &
                zonalstats4d_intint_llf_td_li, &
                zonalstats4d_intfloat_llf_td_li, &
                zonalstats4d_intdouble_llf_td_li, &
                zonalstats4d_floatbyte_llf_td_li, &
                zonalstats4d_floatshort_llf_td_li, &
                zonalstats4d_floatint_llf_td_li, &
                zonalstats4d_floatfloat_llf_td_li, &
                zonalstats4d_floatdouble_llf_td_li, &
                zonalstats4d_doublebyte_llf_td_li, &
                zonalstats4d_doubleshort_llf_td_li, &
                zonalstats4d_doubleint_llf_td_li, &
                zonalstats4d_doublefloat_llf_td_li, &
                zonalstats4d_doubledouble_llf_td_li, &
                zonalstats4d_bytebyte_llf_td_lf, &
                zonalstats4d_byteshort_llf_td_lf, &
                zonalstats4d_byteint_llf_td_lf, &
                zonalstats4d_bytefloat_llf_td_lf, &
                zonalstats4d_bytedouble_llf_td_lf, &
                zonalstats4d_shortbyte_llf_td_lf, &
                zonalstats4d_shortshort_llf_td_lf, &
                zonalstats4d_shortint_llf_td_lf, &
                zonalstats4d_shortfloat_llf_td_lf, &
                zonalstats4d_shortdouble_llf_td_lf, &
                zonalstats4d_intbyte_llf_td_lf, &
                zonalstats4d_intshort_llf_td_lf, &
                zonalstats4d_intint_llf_td_lf, &
                zonalstats4d_intfloat_llf_td_lf, &
                zonalstats4d_intdouble_llf_td_lf, &
                zonalstats4d_floatbyte_llf_td_lf, &
                zonalstats4d_floatshort_llf_td_lf, &
                zonalstats4d_floatint_llf_td_lf, &
                zonalstats4d_floatfloat_llf_td_lf, &
                zonalstats4d_floatdouble_llf_td_lf, &
                zonalstats4d_doublebyte_llf_td_lf, &
                zonalstats4d_doubleshort_llf_td_lf, &
                zonalstats4d_doubleint_llf_td_lf, &
                zonalstats4d_doublefloat_llf_td_lf, &
                zonalstats4d_doubledouble_llf_td_lf, &
                zonalstats4d_bytebyte_lld_ti_li, &
                zonalstats4d_byteshort_lld_ti_li, &
                zonalstats4d_byteint_lld_ti_li, &
                zonalstats4d_bytefloat_lld_ti_li, &
                zonalstats4d_bytedouble_lld_ti_li, &
                zonalstats4d_shortbyte_lld_ti_li, &
                zonalstats4d_shortshort_lld_ti_li, &
                zonalstats4d_shortint_lld_ti_li, &
                zonalstats4d_shortfloat_lld_ti_li, &
                zonalstats4d_shortdouble_lld_ti_li, &
                zonalstats4d_intbyte_lld_ti_li, &
                zonalstats4d_intshort_lld_ti_li, &
                zonalstats4d_intint_lld_ti_li, &
                zonalstats4d_intfloat_lld_ti_li, &
                zonalstats4d_intdouble_lld_ti_li, &
                zonalstats4d_floatbyte_lld_ti_li, &
                zonalstats4d_floatshort_lld_ti_li, &
                zonalstats4d_floatint_lld_ti_li, &
                zonalstats4d_floatfloat_lld_ti_li, &
                zonalstats4d_floatdouble_lld_ti_li, &
                zonalstats4d_doublebyte_lld_ti_li, &
                zonalstats4d_doubleshort_lld_ti_li, &
                zonalstats4d_doubleint_lld_ti_li, &
                zonalstats4d_doublefloat_lld_ti_li, &
                zonalstats4d_doubledouble_lld_ti_li, &
                zonalstats4d_bytebyte_lld_ti_lf, &
                zonalstats4d_byteshort_lld_ti_lf, &
                zonalstats4d_byteint_lld_ti_lf, &
                zonalstats4d_bytefloat_lld_ti_lf, &
                zonalstats4d_bytedouble_lld_ti_lf, &
                zonalstats4d_shortbyte_lld_ti_lf, &
                zonalstats4d_shortshort_lld_ti_lf, &
                zonalstats4d_shortint_lld_ti_lf, &
                zonalstats4d_shortfloat_lld_ti_lf, &
                zonalstats4d_shortdouble_lld_ti_lf, &
                zonalstats4d_intbyte_lld_ti_lf, &
                zonalstats4d_intshort_lld_ti_lf, &
                zonalstats4d_intint_lld_ti_lf, &
                zonalstats4d_intfloat_lld_ti_lf, &
                zonalstats4d_intdouble_lld_ti_lf, &
                zonalstats4d_floatbyte_lld_ti_lf, &
                zonalstats4d_floatshort_lld_ti_lf, &
                zonalstats4d_floatint_lld_ti_lf, &
                zonalstats4d_floatfloat_lld_ti_lf, &
                zonalstats4d_floatdouble_lld_ti_lf, &
                zonalstats4d_doublebyte_lld_ti_lf, &
                zonalstats4d_doubleshort_lld_ti_lf, &
                zonalstats4d_doubleint_lld_ti_lf, &
                zonalstats4d_doublefloat_lld_ti_lf, &
                zonalstats4d_doubledouble_lld_ti_lf, &
                zonalstats4d_bytebyte_lld_tf_li, &
                zonalstats4d_byteshort_lld_tf_li, &
                zonalstats4d_byteint_lld_tf_li, &
                zonalstats4d_bytefloat_lld_tf_li, &
                zonalstats4d_bytedouble_lld_tf_li, &
                zonalstats4d_shortbyte_lld_tf_li, &
                zonalstats4d_shortshort_lld_tf_li, &
                zonalstats4d_shortint_lld_tf_li, &
                zonalstats4d_shortfloat_lld_tf_li, &
                zonalstats4d_shortdouble_lld_tf_li, &
                zonalstats4d_intbyte_lld_tf_li, &
                zonalstats4d_intshort_lld_tf_li, &
                zonalstats4d_intint_lld_tf_li, &
                zonalstats4d_intfloat_lld_tf_li, &
                zonalstats4d_intdouble_lld_tf_li, &
                zonalstats4d_floatbyte_lld_tf_li, &
                zonalstats4d_floatshort_lld_tf_li, &
                zonalstats4d_floatint_lld_tf_li, &
                zonalstats4d_floatfloat_lld_tf_li, &
                zonalstats4d_floatdouble_lld_tf_li, &
                zonalstats4d_doublebyte_lld_tf_li, &
                zonalstats4d_doubleshort_lld_tf_li, &
                zonalstats4d_doubleint_lld_tf_li, &
                zonalstats4d_doublefloat_lld_tf_li, &
                zonalstats4d_doubledouble_lld_tf_li, &
                zonalstats4d_bytebyte_lld_tf_lf, &
                zonalstats4d_byteshort_lld_tf_lf, &
                zonalstats4d_byteint_lld_tf_lf, &
                zonalstats4d_bytefloat_lld_tf_lf, &
                zonalstats4d_bytedouble_lld_tf_lf, &
                zonalstats4d_shortbyte_lld_tf_lf, &
                zonalstats4d_shortshort_lld_tf_lf, &
                zonalstats4d_shortint_lld_tf_lf, &
                zonalstats4d_shortfloat_lld_tf_lf, &
                zonalstats4d_shortdouble_lld_tf_lf, &
                zonalstats4d_intbyte_lld_tf_lf, &
                zonalstats4d_intshort_lld_tf_lf, &
                zonalstats4d_intint_lld_tf_lf, &
                zonalstats4d_intfloat_lld_tf_lf, &
                zonalstats4d_intdouble_lld_tf_lf, &
                zonalstats4d_floatbyte_lld_tf_lf, &
                zonalstats4d_floatshort_lld_tf_lf, &
                zonalstats4d_floatint_lld_tf_lf, &
                zonalstats4d_floatfloat_lld_tf_lf, &
                zonalstats4d_floatdouble_lld_tf_lf, &
                zonalstats4d_doublebyte_lld_tf_lf, &
                zonalstats4d_doubleshort_lld_tf_lf, &
                zonalstats4d_doubleint_lld_tf_lf, &
                zonalstats4d_doublefloat_lld_tf_lf, &
                zonalstats4d_doubledouble_lld_tf_lf, &
                zonalstats4d_bytebyte_lld_td_li, &
                zonalstats4d_byteshort_lld_td_li, &
                zonalstats4d_byteint_lld_td_li, &
                zonalstats4d_bytefloat_lld_td_li, &
                zonalstats4d_bytedouble_lld_td_li, &
                zonalstats4d_shortbyte_lld_td_li, &
                zonalstats4d_shortshort_lld_td_li, &
                zonalstats4d_shortint_lld_td_li, &
                zonalstats4d_shortfloat_lld_td_li, &
                zonalstats4d_shortdouble_lld_td_li, &
                zonalstats4d_intbyte_lld_td_li, &
                zonalstats4d_intshort_lld_td_li, &
                zonalstats4d_intint_lld_td_li, &
                zonalstats4d_intfloat_lld_td_li, &
                zonalstats4d_intdouble_lld_td_li, &
                zonalstats4d_floatbyte_lld_td_li, &
                zonalstats4d_floatshort_lld_td_li, &
                zonalstats4d_floatint_lld_td_li, &
                zonalstats4d_floatfloat_lld_td_li, &
                zonalstats4d_floatdouble_lld_td_li, &
                zonalstats4d_doublebyte_lld_td_li, &
                zonalstats4d_doubleshort_lld_td_li, &
                zonalstats4d_doubleint_lld_td_li, &
                zonalstats4d_doublefloat_lld_td_li, &
                zonalstats4d_doubledouble_lld_td_li, &
                zonalstats4d_bytebyte_lld_td_lf, &
                zonalstats4d_byteshort_lld_td_lf, &
                zonalstats4d_byteint_lld_td_lf, &
                zonalstats4d_bytefloat_lld_td_lf, &
                zonalstats4d_bytedouble_lld_td_lf, &
                zonalstats4d_shortbyte_lld_td_lf, &
                zonalstats4d_shortshort_lld_td_lf, &
                zonalstats4d_shortint_lld_td_lf, &
                zonalstats4d_shortfloat_lld_td_lf, &
                zonalstats4d_shortdouble_lld_td_lf, &
                zonalstats4d_intbyte_lld_td_lf, &
                zonalstats4d_intshort_lld_td_lf, &
                zonalstats4d_intint_lld_td_lf, &
                zonalstats4d_intfloat_lld_td_lf, &
                zonalstats4d_intdouble_lld_td_lf, &
                zonalstats4d_floatbyte_lld_td_lf, &
                zonalstats4d_floatshort_lld_td_lf, &
                zonalstats4d_floatint_lld_td_lf, &
                zonalstats4d_floatfloat_lld_td_lf, &
                zonalstats4d_floatdouble_lld_td_lf, &
                zonalstats4d_doublebyte_lld_td_lf, &
                zonalstats4d_doubleshort_lld_td_lf, &
                zonalstats4d_doubleint_lld_td_lf, &
                zonalstats4d_doublefloat_lld_td_lf, &
                zonalstats4d_doubledouble_lld_td_lf
